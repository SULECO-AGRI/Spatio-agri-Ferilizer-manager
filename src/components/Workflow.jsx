    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto px-6 z-10">
        ...
        <div className="mb-20 text-center max-w-3xl mx-auto">
          ...
          <h2 className="font-heading text-4xl font-bold tracking-tight text-slate-900 md:text-5xl leading-tight">
            From Sky to Soil in 5 Steps
          </h2>
          <p className="mt-4 text-slate-500 max-w-xl mx-auto text-base md:text-lg font-body">
                    ...
                    <div className="flex justify-end">
                      {!isEven ? (
                        ...
                        >
                          ...
                          <p className="text-slate-500 font-body text-sm sm:text-base leading-relaxed max-w-md ml-auto">
                            {step.body}
                          </p>
                        </motion.div>
                      ) : (
                    ...
                    <div className="flex justify-start">
                      {isEven ? (
                        ...
                        >
                          ...
                          <p className="text-slate-500 font-body text-sm sm:text-base leading-relaxed max-w-md">
                            {step.body}
                          </p>
                        </motion.div>
                      ) : (
                  ...
                  <div className="flex md:hidden items-start gap-4 w-full">
                    ...
                    >
                      <div>
                        ...
                        <p className="text-slate-500 font-body text-xs sm:text-sm leading-relaxed mt-1">
                          {step.body}
                        </p>
                      </div>
